...
${DOCKER_COMMAND} exec -T translations yarn wsrun --exclude-missing i18n:extract

# Merge translations from all packages together
${DOCKER_COMMAND} exec -T translations ./package-translations/merge-strings.sh
...
${DOCKER_COMMAND} exec -T -u root translations ./package-translations/sync-strings.sh
